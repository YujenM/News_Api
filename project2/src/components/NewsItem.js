...
render() {
    ...
    return (
        <div className='mt-6'>
            <div className='container check mx-auto grid lg:grid-cols-3 md:grid-cols-2 '>
                ...
                <div className='info '>
                    ...
                    <p className='newsdescription'>Author: {!author?"Unknown":author}</p>
                    <p className='newsdescription'>Date: {new Date(date).toUTCString()}</p>
